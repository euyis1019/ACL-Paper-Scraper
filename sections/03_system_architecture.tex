...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{Fig/system_overview.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{Fig/paper_understanding.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{Fig/deep_research.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{Fig/multi_model.png}
    \caption{Phase 4: Multi-Model Consensus Mechanism. Three independent reviewers (GPT-5, Claude 4.5 Sonnet, DeepSeek-V3.2) provide parallel assessments, synthesized by a fourth model (Gemini 3.0) serving as Area Chair.}
...
\begin{itemize}[nosep,leftmargin=*]
    \item \textbf{Reviewer 1}: GPT-5~\cite{openai2025gpt5} (OpenAI) --- state-of-the-art reasoning and multimodal capabilities
    \item \textbf{Reviewer 2}: Claude 4.5 Sonnet~\cite{anthropic2025claude45sonnet} (Anthropic) --- superior nuanced analysis and instruction following
    \item \textbf{Reviewer 3}: DeepSeek-V3.2~\cite{deepseekai2025deepseekv32} (DeepSeek) --- cost-effective with strong academic text understanding
    \item \textbf{Meta Reviewer}: Gemini 3.0~\cite{google2025gemini3} (Google) --- fast, independent synthesis avoiding self-evaluation bias
\end{itemize}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{Fig/evaluation_dims.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\linewidth]{Fig/ourput_report.png}
...
\begin{enumerate}[nosep,leftmargin=*]
    ...
    \item \textbf{Reviewer Summary}: Individual ratings from GPT-5, Claude 4.5 Sonnet, and DeepSeek-V3.2
